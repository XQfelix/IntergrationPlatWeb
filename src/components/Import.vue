<template>
  <div>
    <el-card shadow="hover">
      <el-page-header @back="goBack" content="代码录入"></el-page-header>
      <p
    ...
    <el-dialog title="保存确认" :visible.sync="centerDialogVisible" close-on-click-modal width="25%">
      <p style="font-size:14px">为了文档查阅时候更清晰, 且符合安全规范, 请您进行如下确认</p>
      <p style="font-size:14px; color:#e6a23c; font-size: 13px">1.文档中涉及IP, 用户, 密码等涉密信息是否处理</p>
      <p style="font-size:14px; color:#e6a23c; font-size: 13px">2.文档内容是否格式化</p>
